...
#### Main:
pd.DataFrame(columns=['FID', 'FD_HASH_Rekisteröinti..numero', 'AVOHILMOID', 'KAYNTI_ALKOI', 'TAPATURMATYYPPI', 'ULKOINEN_SYY', 'ICD10']).to_csv(outpath_avohilmo, encoding='latin-1', index=False)
