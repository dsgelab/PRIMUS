...
This version (V2) is also adding the DOCTOR_ID column to the output, 
which will allow us to do stratified analyses by self-prescription behaviour
"""
    ...
    if not diag_event_codes:
        ...
        for event_code in diag_event_codes:
            ...
            if len(event_df) > 0:
                ...
                event_df = event_df.select(["PATIENT_ID", "CODE", "DATE", "SOURCE", "DOCTOR_ID"])
