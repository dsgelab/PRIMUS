...
write.table(event_df1, sprintf("/media/volume/Projects/DSGELabProject1/DiD_Highthroughput/Version2/GeneratePairs/event_codes_ATC_%s.csv", DATE), row.names = FALSE, col.names = FALSE, quote = FALSE, sep = ",")
write.table(outcome_df1, sprintf("/media/volume/Projects/DSGELabProject1/DiD_Highthroughput/Version2/GeneratePairs/outcome_codes_ATC_%s.csv", DATE), row.names = FALSE, col.names = FALSE, quote = FALSE, sep = ",")
write.table(event_df2, sprintf("/media/volume/Projects/DSGELabProject1/DiD_Highthroughput/Version2/GeneratePairs/event_codes_ICD_%s.csv", DATE), row.names = FALSE, col.names = FALSE, quote = FALSE, sep = ",")
write.table(outcome_df2, sprintf("/media/volume/Projects/DSGELabProject1/DiD_Highthroughput/Version2/GeneratePairs/outcome_codes_ICD_%s.csv", DATE), row.names = FALSE, col.names = FALSE, quote = FALSE, sep = ",")
