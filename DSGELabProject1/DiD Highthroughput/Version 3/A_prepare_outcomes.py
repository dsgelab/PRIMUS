...
if args.output_file is not None:
    ...
    output_file = f"/media/volume/Projects/DSGELabProject1/DiD_Highthroughput/Version3/GeneratePairs/OutcomeCounts_{today_str}.csv"
...
for chunk in pd.read_csv(input_file, chunksize=chunk_size):
    ...
    # use full ATC code (7 characters)
    chunk_clean['CODE'] = chunk_clean['CODE'].astype(str)
    chunk_clean = chunk_clean[chunk_clean['CODE'].str.len() == 7]
