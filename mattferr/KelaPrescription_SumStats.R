...
header = fread(Kela_header_path)$new_name

data_outpath <- "~/Desktop/shared-directory/data_dictionaries/KelaPrescription_SumStats_20250122.csv"
plot1_outpath = "~/Desktop/shared-directory/data_dictionaries/KelaPrescription_unique_values_20250122/"
plot2_outpath = "~/Desktop/shared-directory/data_dictionaries/KelaPrescription_pct_missing_20250122/"
...
# fetch data
file_paths = list.files(path = Kela_path, full.names = TRUE, pattern = "LAAKEOSTOT.*\\d{4}")
year_list = seq(1998, 2022, by = 1)
...
# Reshape the dataframe for plotting without using tidyr
