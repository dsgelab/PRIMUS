...
Avohilmo_header1_path <- "~/Desktop/shared-directory/data_dictionaries/THL/Avohilmo_11_19"
Avohilmo_header2_path <- "~/Desktop/shared-directory/data_dictionaries/THL/Avohilmo_20_22"
header1 = fread(Avohilmo_header1_path)$new_name
header2 = fread(Avohilmo_header2_path)$new_name

data_outpath <- "~/Desktop/shared-directory/data_dictionaries/THL_Avohilmo_SumStats_20250129.csv"
plot1_outpath = "~/Desktop/shared-directory/data_dictionaries/THL_Avohilmo_SumStats_unique_values_20250129/"
plot2_outpath = "~/Desktop/shared-directory/data_dictionaries/THL_Avohilmo_SumStats_pct_missing_20250129/"
...
# fetch data
file_paths = list.files(path = THL_path, full.names = TRUE, pattern = "AH_\\d+.*")
year_list = seq(1, 14, by = 1)
