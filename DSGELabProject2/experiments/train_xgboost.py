...
def train():
    ...
    summary_df = pd.DataFrame(
        {
            "statistic": ["trainfile", "balanced", "dropna", "nsearch" "Train_AUPRC", "Val_AUPRC"],
            "value": [args.trainfile, args.balanced, args.dropna, args.nsearch, auprc_train, auprc_val],
        }
    )
    ...
    plt.title("SHAP Beeswarm Plot", fontsize=max_display)
