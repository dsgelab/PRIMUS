...
write.csv(diag_history_pat, paste0(icd10_code_no_dot, "PatientDiagnosisHistory_", current_date, ".csv"), row.names = FALSE)
print(paste0("Patient diagnosis history saved to ", paste0(icd10_code_no_dot, "PatientDiagnosisHistory_", current_date, ".csv")))
rm(all_diagnoses)
...
write.csv(pres_history_pat, paste0(icd10_code_no_dot, "PatientPrescriptionHistory_", current_date, ".csv"), row.names = FALSE)
print(paste0("Patient prescription history saved to ", paste0(icd10_code_no_dot, "PatientPrescriptionHistory_", current_date, ".csv")))