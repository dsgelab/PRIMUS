...
def main():
    ...
    parser.add_argument(
        "--suffix", help="Suffix for output files (default='').", type=str, default=""
    )
    parser.add_argument("--inputfile", help="Path to the file containing training samples.", type=str, default="J069DiagnosesWithPrescriptions")
