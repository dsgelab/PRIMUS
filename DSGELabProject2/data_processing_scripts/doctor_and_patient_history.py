...
def add_mean_past_yearly_column(events_file, events_dtypes, event_history, date_column, id_column, event_label, person_label):
    """
    ...
    event_history.loc[mask_valid, yearly_column_name] = (event_history.loc[mask_valid, "N_EVENTS_BEFORE"] / years[mask_valid]).round(1)
...
def calculate_history(events_filename, events_dtypes, code_column, date_column, history_column_prefix, outfile_label, diagnosis):
    ...
    add_mean_past_yearly_column(events_file, events_dtypes, doctor_event_history, date_column, "DOCTOR_ID", outfile_label, "Doctor")
    ...
    add_mean_past_yearly_column(events_file, events_dtypes, patient_event_history, date_column, "PATIENT_ID", outfile_label, "Patient")
